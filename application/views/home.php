<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  ...
  <nav class="my-2 my-md-0 mr-md-3">
    <a class="p-2 text-dark" href="<?=base_url('tambah')?>">Tambah Data</a>
  </nav>
  <a class="btn btn-outline-primary" href="<?=base_url('logout')?>">Sign Out</a>
</div>

<div class="pricing-header px-3 py-1 pt-md-3 pb-md-4 mx-auto text-center">
  <h1 class="display-4 pt-0">Tabel Nilai Kelas 4IAXX</h1>
    ...
    <tbody>
      ...
      <tr <?php if($data['keterangan'] == "Tidak Lulus"){
        ...
        <td class="align-middle text-center">
          <a href="<?=base_url('edit/'.$data['id_nilai'])?>" class="align-middle btn btn-success">Edit</a>
          <a href="<?=base_url('delete/'.$data['id_nilai'])?>" onclick="return confirm('Apakah anda yakin data ini akan dihapus?')" class="align-middle btn btn-danger">Hapus</a>
        </td>
      </tr>
      <?php endforeach?>
    </tbody>
